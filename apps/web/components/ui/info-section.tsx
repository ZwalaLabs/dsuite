			...
			<div className="flex overflow-auto -mx-4 sm:mx-0">
				...
				>
					{FEATURE_SECTION.FEATURES.map(({ IMAGE, TITLE }:{IMAGE:string, TITLE: string}) => (
						<li className='group text-sm font-semibold w-full flex flex-col items-center hover:text-pink-400 cursor-pointer' key={TITLE}>
							{/* image and title */}
							{IMAGE ? <Image src={IMAGE} alt={TITLE} width={260} height={260}/> : null}
